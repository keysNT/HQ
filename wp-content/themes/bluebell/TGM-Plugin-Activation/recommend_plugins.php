...
function consult_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'      => esc_html__('Unyson', 'consult'),
            'slug'      => 'unyson',
            'required'  => true,
        )
    );
    ...
    $config = array(
        ...
        'strings'      => array(
            'page_title'                      => esc_attr__( 'Install Required Plugins', 'consult' ),
            'menu_title'                      => esc_attr__( 'Install Plugins', 'consult' ),
            'installing'                      => esc_attr__( 'Installing Plugin: %s', 'consult' ), // %s = plugin name.
            'oops'                            => esc_attr__( 'Something went wrong with the plugin API.', 'consult' ),
            ...
            'return'                          => esc_attr__( 'Return to Required Plugins Installer', 'consult' ),
            'plugin_activated'                => esc_attr__( 'Plugin activated successfully.', 'consult' ),
            'complete'                        => esc_attr__( 'All plugins installed and activated successfully. %s', 'consult' ), // %s = dashboard link.
